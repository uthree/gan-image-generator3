...
dataset = ImageDataset(source_dir_pathes=sys.argv[1:], chache_dir="./dataset_chache/", max_len=4000000)
model.train(dataset, batch_size=64, num_epoch=300,  augment_func=aug)
