...
dataset = ImageDataset(source_dir_pathes=sys.argv[1:], chache_dir="./dataset_chache/", max_len=10000)
model.train(dataset, batch_size=48, num_epoch=200,  augment_func=aug)
